...
export const metadata: Metadata = {
  title: 'Terms of Service — Kevosh',
  description: 'Kevosh Terms of Service, Acceptable Use Policy, Founder Consent Warranties, and Limitation of Liability.',
};
  ...
  return (
    <div className="min-h-screen bg-[#fafafa] text-[#09090b] flex flex-col font-sans">
      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-4 sm:px-6 py-8 sm:py-12 space-y-8">
        ...
        <div className="border-b border-zinc-200 pb-6 space-y-2">
          ...
          <p className="text-sm text-zinc-600 max-w-2xl leading-relaxed">
            These Terms of Service govern your access to and use of Kevosh’s revenue attribution platform, APIs, tracking scripts, and dashboard services.
          </p>
        </div>
        ...
        <div className="space-y-8 text-sm text-zinc-700 leading-relaxed font-sans">
          ...
          <section className="space-y-3">
            ...
            <p>
              By creating an account, connecting Stripe or Dodo Payments webhooks, or embedding Kevosh tracking scripts into your application, you ("Founder" or "Customer") agree to be bound by these Terms of Service. If you are entering into this agreement on behalf of a company, you represent that you have legal authority to bind that entity.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p>
              Kevosh provides a multi-channel revenue attribution engine that ingests payment provider webhooks (Stripe and Dodo Payments) and matches them against top-of-funnel marketing sources.
            </p>
          ...
          <section className="space-y-3">
            ...
            <p>You agree NOT to use Kevosh to:</p>
            <ul className="list-disc pl-5 space-y-1 text-xs text-zinc-600">
          ...
          <section className="space-y-3">
            ...
            <div className="p-4 bg-amber-50/80 border border-amber-200 rounded-xl space-y-2 text-xs text-amber-950">
              ...
              <p className="leading-relaxed">
                Founders act as the <strong>Data Controller</strong> for all end-customer personal data (including emails, referral URLs, and UTM parameters) transmitted to Kevosh.
              </p>
              <p className="leading-relaxed">
                The Founder explicitly warrants that they have obtained all legally required user consents, posted compliant privacy notices on their website/app, and maintained a valid legal basis under GDPR, CCPA, and applicable local privacy laws before capturing or transmitting end-customer data to Kevosh.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-xs text-zinc-600">
              Subscription billing for Kevosh Pro ($20/month) is billed in advance on a recurring monthly basis via Dodo Payments. You may cancel your subscription at any time through your dashboard settings. Upon cancellation, your subscription remains active until the end of the current paid billing period.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <p className="text-xs text-zinc-600">
              Kevosh reserves the right to suspend or terminate accounts that violate our Acceptable Use Policy or engage in fraudulent activity.
            </p>
          </section>
          ...
          <section className="space-y-3">
            ...
            <div className="p-4 bg-white border border-zinc-200 rounded-xl space-y-2 text-xs text-zinc-600">
              <p>
                <strong>AS-IS Basis:</strong> Kevosh is provided on an "AS IS" and "AS AVAILABLE" basis without warranties of any kind, whether express or implied.
              </p>
              <p>
                <strong>Liability Cap:</strong> To the maximum extent permitted by applicable law, Kevosh and its operators shall not be liable for any indirect, incidental, special, consequential, or punitive damages, or loss of profits or revenues. In no event shall our total aggregate liability exceed the amount paid by the Founder to Kevosh in the twelve (12) months preceding the claim.
              </p>
            </div>
          </section>
          ...
          <section className="space-y-3 pt-4 border-t border-zinc-200">
            ...
            <div className="p-4 bg-zinc-100 border border-zinc-200 rounded-xl font-mono text-xs text-zinc-800 space-y-1">
              <p className="font-bold text-zinc-950">Kevosh Legal Team</p>
      ...
      <footer className="border-t border-zinc-200 bg-white py-6 px-4 text-center text-xs text-zinc-500 font-mono">
        <p>© {new Date().getFullYear()} Kevosh. All rights reserved. | <Link href="/privacy" className="underline hover:text-zinc-800">Privacy Policy</Link></p>
      </footer>
    </div>
  );
}
